...
build_time_vars = {'ABIFLAGS': '',
 ...
 'CONFIG_ARGS': "'--prefix=/usr' '--exec_prefix=/usr' '--with-ensurepip' "
 ...
 'COREPYTHONPATH': '',
 'COVERAGE_INFO': '/data/abdelali/google-cloud-sdk/git/docker_container/Python-3.10.5/coverage.info',
 'COVERAGE_REPORT': '/data/abdelali/google-cloud-sdk/git/docker_container/Python-3.10.5/lcov-report',
 ...
 'abs_builddir': '/data/abdelali/google-cloud-sdk/git/docker_container/Python-3.10.5',
 'abs_srcdir': '/data/abdelali/google-cloud-sdk/git/docker_container/Python-3.10.5',
