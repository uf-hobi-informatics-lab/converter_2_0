...
spark = cf.get_spark_session("hash_token_ne_mapper")
...
try:
    ...
    ###################################################################################################################################
        ...
        unmapped_hash_token    = cf.spark_read(deduplicated_data_folder_path+"deduplicated_hash_token_ne.csv", spark)
    ...
    ###################################################################################################################################
        ...
        cf.write_pyspark_output_file(
                        ...
                        output_file_name = "mapped_hash_token_ne.csv",
