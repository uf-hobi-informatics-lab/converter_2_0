...
try: 
    ...
    ###################################################################################################################################
        ...
        external_meds = unmapped_external_meds.select(              
                                    ...
                                    coalesce(mapping_ext_dose_form_dict[col("EXT_DOSE_FORM")],col('EXT_DOSE_FORM')).alias("EXT_DOSE_FORM"),
                                    coalesce(mapping_ext_route_dict[col("EXT_ROUTE")],col('EXT_ROUTE')).alias("EXT_ROUTE"),
                                    coalesce(mapping_ext_basis_dict[col("EXT_BASIS")],col('EXT_BASIS')).alias("EXT_BASIS"),
                                    unmapped_external_meds['RXNORM_CUI'].alias("RXNORM_CUI"),
                                    coalesce(mapping_extmed_source_dict[col("EXTMED_SOURCE")],col('EXTMED_SOURCE')).alias("EXTMED_SOURCE"),
