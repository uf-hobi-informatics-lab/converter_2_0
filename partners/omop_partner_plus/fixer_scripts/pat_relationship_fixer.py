...
partner_name = 'omop_partner_pluas'
mapped_table_name ='mapped_death_cause.csv'
fixed_table_name = 'fixed_death_cause.csv'
...
fixes = {
    ...
    "1": {"fix_type":"common",    "fix_name":"patid_orphans_fix",   "version":"1.0", "src1":"mapped_demographic.csv", "src2":"PATID_1"},
    "2": {"fix_type":"common",    "fix_name":"patid_orphans_fix",   "version":"1.0", "src1":"mapped_demographic.csv", "src2":"PATID_2"},
...
try: 
    ...
    mapper_data_folder_path           = f'/app/partners/{partner_name.lower()}/data/mapper_output/{input_data_folder}/'
    fixer_output_data_folder_path     = f'/app/partners/{partner_name.lower()}/data/fixer_output/{input_data_folder}/'
