...
mapped_table_name ='mapped_procedures.csv'
fixed_table_name = 'fixed_procedures.csv'
...
fixes = {
    ...
    "3": {"fix_type":"common",    "fix_name":"providerid_orphans_fix",    "version":"1.0", "src1":"mapped_provider.csv",    "src2":"PROVIDERID"},
    "4": {"fix_type":"common",    "fix_name":"replication_fix",     "version":"1.0", "src1":"mapped_encounter.csv",   "src2":"NotUsed"},
