...
try: 
    ...
    immunization_in = spark.read.load(input_data_folder_path+immunization_table_name,format="csv", sep="~", inferSchema="true", header="true", quote= '"')
    ...
    immunization = immunization_in.select(
                    ...
                    immunization_in['vx_code_type'].alias('VX_CODE_TYPE'),
                    immunization_in['vx_code'].alias('VX_CODE'),
                    immunization_in['vx_status'].alias('VX_STATUS'),
                    immunization_in['vx_status_reason'].alias('VX_STATUS_REASON'),
                    immunization_in['vx_source'].alias('VX_SOURCE'),
                    immunization_in['vx_dose'].alias('VX_DOSE'),
                    immunization_in['vx_dose_unit'].alias('VX_DOSE_UNIT'),
                    immunization_in['vx_route'].alias('VX_ROUTE'),
                    immunization_in['vx_body_site'].alias('VX_BODY_SITE'),
                    immunization_in['vx_manufacturer'].alias('VX_MANUFACTURER'),
