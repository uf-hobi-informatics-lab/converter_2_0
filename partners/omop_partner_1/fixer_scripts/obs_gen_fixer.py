...
mapped_table_name ='mapped_obs_gen.csv'
fixed_table_name = 'fixed_obs_gen.csv'
...
fixes = {
    ...
    "3": {"fix_type":"common",    "fix_name":"providerid_orphans_fix",    "version":"1.0", "src1":"mapped_provider.csv",    "src2":"OBSGEN_PROVIDERID"},
