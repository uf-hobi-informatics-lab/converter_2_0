...
try: 
    ...
    prescribing = filtered_drug_exposure.select(    filtered_drug_exposure['drug_exposure_id'].alias("PRESCRIBINGID"),
                                                    ...
                                                    cf.get_time_from_datetime_udf(filtered_drug_exposure['drug_exposure_start_datetime']).alias("RX_ORDER_TIME"),
                                                    filtered_drug_exposure['drug_exposure_start_date'].alias("RX_START_DATE"),
                                                    cf.get_time_from_datetime_udf(filtered_drug_exposure['drug_exposure_end_date']).alias("RX_END_DATE"),
