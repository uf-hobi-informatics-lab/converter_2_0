...
###################################################################################################################################
    ...
    observation_table_name            = 'test_observation.csv'
    ...
    vital_uncombined = filtered_observation.select( filtered_observation['observation_id'].alias("VITALID"),
                                                    ...
                                                    filtered_observation['observation_start_date'].alias("MEASURE_DATE"),
                                                    convert_and_format_time_udf(observation['observation_start_datetime']).alias("MEASURE_TIME"),
